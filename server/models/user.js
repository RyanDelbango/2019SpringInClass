...
const model = {
    async getAll(){
        return await conn.query("SELECT * FROM 2019Spring_Persons WHERE firstName IS NOT NULL");   
    },
    async get(id){
    ...
    async add(input){
        ...
        const data = await conn.query(
            "INSERT INTO 2019Spring_Persons (FirstName,LastName,Birthday,Password,created_on) VALUES (?)",
